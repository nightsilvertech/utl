...
const (
	...
	authorization     metaContext = "authorization"
)

func Create(ctx context.Context, id string) context.Context {
	return metadata.NewIncomingContext(ctx, metadata.Pairs(string(correlationID), id))
}

func CreateReqHeader(ctx context.Context, id string) context.Context {
	return metadata.NewIncomingContext(ctx, metadata.Pairs(string(correlationID), id))
}


func InjectAuthToken(ctx context.Context, md *metadata.MD) context.Context {
